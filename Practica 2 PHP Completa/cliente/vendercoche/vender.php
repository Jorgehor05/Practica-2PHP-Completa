...
<header>
    ...
    <div class="container">
        ...
        <form action="vender2.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="modelo" name="modelo" placeholder="Añade el modelo modelo...">
            
            <label for="color">Color:</label>
            <input type="text" id="color" name="color" placeholder="Añade el color...">
			
			<label for="color"> Precio máximo:</label>
            <input type="number" id="precio" name="precio" placeholder="Cual es el precio...">
			
			<label for="foto">Subir Imagen:</label>
			<input type="file" id="foto" name="foto" accept="image/*" required>
            
            <input type="submit" value="Vender coche">
        </form>
    </div>
